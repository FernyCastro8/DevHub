        ...
        <div className="h-screen w-screen bg-gray-100 pb-16 overflow-auto">
            <section class="developer'form">
                <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                    <h1 class="mb-6 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl">Discover Elite Talent for Your Projects!
                    </h1>
                    <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">🎯 Showcase Your Skills: Stand out from the crowd by displaying your expertise to our vibrant community.
                    </p>
                    <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">🤝 Connect with Industry Leaders: Network with top professionals, gaining insights and mentorship to fuel your growth.
                    </p>
                    <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">💡 Unlock New Opportunities: Access exclusive projects and collaborations that open doors to exciting career advancements.
                    </p>
                </div>
            </section>
                        ...
                        <div className="grid xl:grid-cols-2 xl:gap-6">
                            ...
                            <div className="relative z-0 mb-6 w-full group">
                                ...
                                <label for="floating_last_name"
                                    className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Position vacancy</label>
                            </div>
                            ...
                            <div className="relative z-0 mb-6 w-full group">
                                ...
                                <label for="floating_phone"
                                    className="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Emploment type (Ex. Full-time/Part-time)</label>
                            </div>
