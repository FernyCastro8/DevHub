...
export default function Register() {
        ...
        <div>
            <div>
                <div className='h-screen   bg-gray-900 '>
                    <div className=''>
                        <h1 className='flex justify-center text-3xl text-white p-10'>Register</h1>
    ...
    <label for="terms" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <a href="#" className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</a></label> */}
                            ...
                            <button type="submit" className=" flex justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
                        </form>
                    </div>
